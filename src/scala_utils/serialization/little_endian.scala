...
object little_endian {
  ...
  implicit def le_short_writer [B] (implicit w : Writer [B, Byte]) : Writer [B, Short] =
    (b : B, t : Short) => write_short (b, t, w)

  implicit def le_int_writer [B] (implicit w : Writer [B, Byte]) : Writer [B, Int] =
    (b : B, t : Int) => write_int (b, t, w)

  implicit def le_long_writer [B] (implicit w : Writer [B, Byte]) : Writer [B, Long] =
    (b : B, t : Long) => write_long (b, t, w)

  implicit def le_short_reader [B] (implicit r : Reader [B, Byte]) : Reader [B, Short] =
    (b : B) => read_short (b, r)

  implicit def le_int_reader [B] (implicit r : Reader [B, Byte]) : Reader [B, Int] =
    (b : B) => read_int (b, r)

  implicit def le_long_reader [B] (implicit r : Reader [B, Byte]) : Reader [B, Long] =
    (b : B) => read_long (b, r)
}
